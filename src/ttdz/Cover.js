    ...
    render(){
        return (
            <span className="global-item">
                <i data-height={this.props.defaultHeight} className={this.props.icon ? 'global-cover icon-play' : 'global-cover'} style={{backgroundImage: 'url(' + this.imageCompression(this.props.poster,this.props.width,this.props.height) + ')'}} />
